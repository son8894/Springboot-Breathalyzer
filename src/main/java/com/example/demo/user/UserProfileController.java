...
java
Copy code
@Select("SELECT * FROM UserProfile WHERE userId=#{userId} AND password=#{password}")
UserProfile getUserProfileByUserIdAndPassword(@Param("userId") String userId, @Param("password") String password);

java
Copy code
@PostMapping("/user/login")
public boolean login(@RequestParam("userId") String userId, @RequestParam("password") String password) {
    UserProfile userProfile = mapper.getUserProfileByUserIdAndPassword(userId, password);
